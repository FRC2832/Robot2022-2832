...
public class ShooterConstants {
    ...
    public static void LoadConstants() {
        ...
        DIST_RPM_TABLE.add(new Pair<Double, Double>(96d, 2435d));
        DIST_RPM_TABLE.add(new Pair<Double, Double>(108d, 2475d));
        DIST_RPM_TABLE.add(new Pair<Double, Double>(120d, 2525d));
        DIST_RPM_TABLE.add(new Pair<Double, Double>(132d, 2600d));
        DIST_RPM_TABLE.add(new Pair<Double, Double>(144d, 2675d));
        ...
        DIST_HOOD_TABLE.add(new Pair<Double, Double>(96d, 38d)); // hood 3
        DIST_HOOD_TABLE.add(new Pair<Double, Double>(108d, 42d)); // hood 3.75
