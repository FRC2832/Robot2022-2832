...
public class AutonOneBall extends CommandBase {
    private Drivetrain drive;
    private Shooter shooter;
    private Ingestor ingestor;
    private Timer timer;

    public AutonOneBall(Drivetrain drive, Shooter shooter, Ingestor ingestor) {
        this.drive = drive;
    ...
    public void execute() {
        ...
        switch (drive.currentStep) { // drive.currentStep = 2;
            case 0: //prep for auton. Lower ingestor at twice normal speed
                ...
                break;
            case 1: //drive off tarmac
                drive.drive(-0.5, 0, 0, false);
                double speed = 2300.0;
                // TODO: Might be able to schedule AutoShoot later.
