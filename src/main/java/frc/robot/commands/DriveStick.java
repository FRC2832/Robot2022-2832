...
public class DriveStick extends CommandBase {
    ...
    public void execute() {
        ...
        double xSpeed = -drive.deadbandStick(controller.getLeftY()) * frc.robot.Drivetrain.kMaxSpeed;

        // Get the y speed or sideways/strafe speed. We are inverting this because
        // we want a positive value when we pull to the left. Xbox controllers
        // return positive values when you pull to the right by default.
        double ySpeed = -drive.deadbandStick(controller.getLeftX()) * frc.robot.Drivetrain.kMaxSpeed;
