...
public class DriveStickSlew extends CommandBase {
    ...
    public void execute() {
        ...
        // field-relative off
        final double xSpeed =
                X_SPEED_LIMITER.calculate(drive.deadbandStick(controller.getLeftY())) * frc.robot.Drivetrain.kMaxSpeed;
        ...
        // field-relative off
        final double ySpeed =
                Y_SPEED_LIMITER.calculate(drive.deadbandStick(controller.getLeftX())) * frc.robot.Drivetrain.kMaxSpeed;
        ...
        final double rot = ROT_LIMITER.calculate(drive.deadbandStick(controller.getRightX())) *
