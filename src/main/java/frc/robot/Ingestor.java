...
//changes made 3/14 problems with altencoder initialization
/*package frc.robot;
...
public class Ingestor {
    ...
    static constexpr auto kMotorType = CANSparkMax::MotorType::kBrushless;
    /*static  kAltEncType = CANEncoder::AlternateEncoderType::kQuadrature;
    static int kCPR = 8192;
    public CANSparkMax m_motor = new CANSparkMax(31, MotorType.kBrushless);
    private CANSparkMax m_alternateEncoder = m_motor.GetAlternateEncoder(kAltEncType, kCPR);
    ...
    public void runIngestor() {
        ...
        if (operatorController.getBButton()) { // lift ingestor
            ingestorLift.set(INGESTOR_LIFT_SPEED);
            SmartDashboard.putNumber("Alt Encoder Velocity", m_alternateEncoder.getVelocity());
