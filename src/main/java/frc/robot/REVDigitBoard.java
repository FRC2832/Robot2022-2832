...
//sample code from https://github.com/vampjaz/REVDigitBoard/blob/master/REVDigitBoard.java
...
////// not supposed to be publicly used..
	...
	void _display(int[] charz) {
		...
		// Timer.delay(0.01);  //sample code had this, but why should we wait 10ms every time we transmit a packet
	}
