...
public class Ingestor extends SubsystemBase {
    ...
    public Ingestor(ColorSensor colorSensor, XboxController operatorController, XboxController driverController) {
        ...
        CANSparkMaxLowLevel.MotorType brushless = CANSparkMaxLowLevel.MotorType.valueOf("kBrushless");
    ...
    public void runIngestor() {
        ...
        if (operatorController.getRightTriggerAxis() >= TRIGGER_SENSITIVITY ||
            driverController.getLeftTriggerAxis() >= TRIGGER_SENSITIVITY) { // ingestor down and in
    ...
    public void stopAll() {
        liftIngestor();
        stage1Conveyor.set(ControlMode.PercentOutput, 0.0);
        stage2Conveyor.set(ControlMode.PercentOutput, 0.0);
        ingestorWheels.set(ControlMode.PercentOutput, 0.0);
    }
