...
public class ClimberNew extends SubsystemBase {
    private static final double CLIMBER_SLOW_SPEED = 0.4;
    private static final double CLIMBER_FAST_SPEED = 0.7;
    ...
    public ClimberNew(Ingestor ingestor, XboxController controller) {
        super();
